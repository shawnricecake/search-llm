...
def get_sample_config(config):
    ...
    sample_attention_head_dim, sample_weight_start = decode_cand_tuple(config)
    sampled_config = {
        'sample_layer_num': sample_layer_num,
    ...
    sample_hidden_size = []
    for i in range(sampled_config['sample_layer_num']):
        temp = int(sampled_config['sample_attention_head_dim'][i] * sampled_config['sample_num_attention_heads'][i])
        sample_hidden_size.append(temp)
    sampled_config['sample_hidden_size'] = sample_hidden_size

    print("sampled config: ")
    for e in sampled_config:
        print(e, sampled_config[e])
